  ...
  return (
    <div>
      ...
      <div className="relative z-20 px-4 py-8 text-white text-center">
        ...
        <p className="my-6 font-sm lg:font-xl text-[rgb(255, 255, 255)] font-normal">Food Village: Explore a world of culinary delights under one roof. <br />Your one-stop shop for convenient and delicious meals</p>
